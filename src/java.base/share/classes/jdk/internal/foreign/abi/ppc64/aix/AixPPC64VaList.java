 ...
 * Aix. Variadic parameters may be passed in registers or on the stack.
 */
public non-sealed class AixPPC64VaList implements VaList, Scoped {
    ...
    private AixPPC64VaList(MemorySegment segment, MemorySegment stack,
    ...
    private static AixPPC64VaList readFromSegment(MemorySegment segment) {
        ...
        return new AixPPC64VaList(segment, stack, gpRegsArea, MAX_GP_OFFSET, fpRegsArea, MAX_FP_OFFSET);
    }
    ...
    public VaList copy() {
        ...
        return new AixPPC64VaList(copy, stack, gpRegsArea, gpLimit, fpRegsArea, fpLimit);
    }
    ...
    public static non-sealed class Builder implements VaList.Builder {
        ...
        public VaList build() {
            ...
            return new AixPPC64VaList(vaListSegment, stackArgsSegment, gpRegs, currentGPOffset, fpRegs, currentFPOffset);
        }
    }
}
