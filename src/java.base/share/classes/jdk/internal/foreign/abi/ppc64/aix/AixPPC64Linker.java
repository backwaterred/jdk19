...
/**
 * ABI implementation based on AIX 'Assembler Language Reference'
 */
public final class AixPPC64Linker extends AbstractLinker {
    ...
    protected MethodHandle arrangeDowncall(MethodType inferredMethodType, FunctionDescriptor function) {
        return CallArranger.AIX.arrangeDowncall(inferredMethodType, function);
    }
    ...
    protected MemorySegment arrangeUpcall(MethodHandle target, MethodType targetType, FunctionDescriptor function, MemorySession scope) {
        return CallArranger.AIX.arrangeUpcall(target, targetType, function, scope);
    }
